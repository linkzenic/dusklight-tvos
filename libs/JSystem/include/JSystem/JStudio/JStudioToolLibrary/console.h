...
namespace JStudioToolLibrary {
    ...
    struct TConsole {
        ...
        void control_generateSelectList(JORMContext*, u32, const char*, u32, const char*, int);
        ...
        void control_generateEditBox_uint(JORMContext*, u32, const char*, const u32&);
        ...
        void control_generateSelectList_style(JORMContext*, u32, u32, const char*, u32, const char**, int);
        ...
        void control_generateEditBox_style_uint(JORMContext*, u32, u32, const char*, const u32&);
        ...
        void control_setEditBox_uint(u32, const u32&);
        ...
        void control_replyEditBox_uint(const JORStrValPrpEvent*, u32*);
        ...
        void control_replyEditBox_uint_range(const JORStrValPrpEvent*, u32*, const u32&, const u32&);

        bool parseValue_int(const char*, int*);
        bool parseValue_uint(const char*, u32*);
        ...
        int openMessageBox(u32, const char*);
        int openMessageBox_f(u32, const char*, ...);
        int openMessageBox_f_va(u32, const char*, va_list);
        bool openBrowser(const char*);

        void toValue_style_(u32);
        void getValueString_int(char*, u32, int);
        void getValueString_uint(char*, u32, u32);
